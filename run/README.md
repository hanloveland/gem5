...
Example
```bash
../build/X86/gem5.opt ../configs/example/se.py -n 1 -c ../tests/test-progs/hello/bin/x86/linux/hello --mem-type Ramulator2 --ramulator-config ../ext/ramulator2/ramulator2/ddr5_config.yaml
```

## Debug 
```bash
../build/X86/gem5.opt --debug-flags=AddrRanges ..
```
## 
